...
class UserRepositoryNotFoundRetrive(UserRepositorySpy):
    def retrieve(self, _: int) -> User:
        raise ValueError("User not found")


class UserRepositoryEmailFilterListSpy(UserRepositorySpy):
...
class UserRepositoryEmptyListSpy(UserRepositorySpy):
